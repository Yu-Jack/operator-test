...
type FakeCronJobs struct {
	Fake *FakeJackV1alpha1
	ns   string
}

var cronjobsResource = schema.GroupVersionResource{Group: "jack.jack.operator.test", Version: "v1alpha1", Resource: "cronjobs"}

var cronjobsKind = schema.GroupVersionKind{Group: "jack.jack.operator.test", Version: "v1alpha1", Kind: "CronJob"}
