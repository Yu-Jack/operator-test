...
import (
	...
	cronjobv1alpha1 "github.com/Yu-Jack/operator-test/apis/cronjob/v1alpha1"
	versioned "github.com/Yu-Jack/operator-test/generated/clientset/versioned"
	internalinterfaces "github.com/Yu-Jack/operator-test/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/Yu-Jack/operator-test/generated/listers/cronjob/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.JackV1alpha1().CronJobs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.JackV1alpha1().CronJobs(namespace).Watch(context.TODO(), options)
			},
		},
