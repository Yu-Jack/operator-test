...
import (
	...
	customscheme "github.com/Yu-Jack/operator-test/generated/clientset/versioned/scheme"
	"k8s.io/client-go/kubernetes/scheme"

	customclient "github.com/Yu-Jack/operator-test/generated/clientset/versioned"
...
type Controller struct {
	lister   customlisters.CronJobLister
	queue    workqueue.RateLimitingInterface
	informer cache.Controller
}

// NewController creates a new Controller.
func NewController(queue workqueue.RateLimitingInterface, lister customlisters.CronJobLister,
...
func main() {
	...
	informer := informerFactory.Jack().V1alpha1().CronJobs()
